...
public class guiclient extends javax.swing.JFrame {
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (client.isConnected == false) {
            client.setUsername(tf_username.getText());
    ...
    private void b_disconnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_disconnectActionPerformed
        ta_chat.append(client.sendDisconnect() + '\n');
        ta_chat.append(client.Disconnect() + '\n');
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        tf_username.setText("");
        if (client.isConnected == false) {
            tf_username.setText(client.getUsername());
            tf_username.setEditable(false);
    ...
    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_sendActionPerformed
        ...
        if ((tf_chat.getText()).equals(nothing)) {
            ...
            try {
                client.getWriter().println(client.getUsername() + ":" + tf_chat.getText() + ":" + "Chat");
                System.out.println(tf_chat.getText());
                client.getWriter().flush(); // flushes the buffer
            } catch (Exception ex) {
